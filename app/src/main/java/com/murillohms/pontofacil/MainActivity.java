package com.murillohms.pontofacil;
...
import com.murillohms.pontofacil.databinding.ActivityMainBinding;
...
import com.murillohms.pontofacil.infrastructure.settings.ConfiguracaoInicialActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(() -> {
            FuncionarioEntity funcionario = repository.getFuncionarioAtivoSync();
    ...
    private void carregarInterfacePrincipal() {
